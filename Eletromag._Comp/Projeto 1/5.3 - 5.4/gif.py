...
import os
with open('/home/edmurcn/Documentos/MeusProjetos/Fis._Estat._Comp./Eletromag._Comp/5.3 - 5.4/fort.1', 'r') as file:
...
for line in lines:
    if line.strip():
        ...
        z = [t[2] for t in coord]
        scatter = ax.scatter([t[0] for t in coord], [t[1] for t in coord], [t[2] for t in coord], c=z, cmap="jet", s=10)
